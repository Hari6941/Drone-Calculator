  ...
  return (
    <div className="glass-card" style={{ height: '100%' }}>
      <div className="glass-card-title">
        ...
        <svg style={{ width: '18px', height: '18px', color: '#ffffff' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          {loading ? (
            <>
              <div className="dot-matrix-loader" style={{ marginRight: '8px' }}>
